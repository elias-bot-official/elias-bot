...
module.exports = {
   ...
   data: new SlashCommandBuilder().setName("balance").setDescription("Shows your current balance.")
   ...
   async onCommandInteraction(interaction: ChatInputCommandInteraction) {
      ...
      interaction.reply({embeds: [new Embed({color: 0x22b1fc, title: `${(user ?? interaction.user).displayName}'s Balance`,
